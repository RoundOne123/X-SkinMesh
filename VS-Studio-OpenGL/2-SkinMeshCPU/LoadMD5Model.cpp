...
// 初始化 +　回调　相关 ***********************************************************************
	...
	// 创建一个窗口
	GLFWwindow *window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Load MD5 Model", NULL, NULL);
	if (window == NULL)
	{
...
// 着色器、模型、贴图 *********************************************************************************
	...
	xShader ourShader("C:/Users/admin/Desktop/opengl-skinmeshrender/VS-Studio-OpenGL/VS-Studio-OpenGL/2-SkinMeshCPU/shader.vs", "C:/Users/admin/Desktop/opengl-skinmeshrender/VS-Studio-OpenGL/VS-Studio-OpenGL/2-SkinMeshCPU/shader.fs");
